...
def main():
    ...
    selected = {'selection_rule': 'max graph_free_validation accuracy; test read only from selected checkpoint',
                ...
                'oracle_evidence_validation': best['metrics']['oracle_evidence_validation'],
                'oracle_evidence_test': best['metrics']['oracle_evidence_test']}
    ...
    for row in rows:
        m=row['metrics']; lines.append(f"| {row['checkpoint']} | {m['graph_free_validation']['accuracy']:.4f} | {m['graph_free_test']['accuracy']:.4f} | {m['oracle_evidence_validation']['accuracy']:.4f} | {m['oracle_evidence_test']['accuracy']:.4f} |")
