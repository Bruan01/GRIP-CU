...
| [`v0_2_oracle_prefix_smoke_2026-09-01`](v0_2_oracle_prefix_smoke_2026-09-01/) | Implemented / GPU pending | 同 rank 比较 monolithic、static split、flat experts、ordered prefix、local credit 与因果对照 |
...
决策：**v0.2 实现和静态门已完成；下一步只运行 WSL 3090 one-seed smoke，不直接实现 learned router。**
